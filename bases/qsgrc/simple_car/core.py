...
from qsgrc.messages.alerts import AlertMessage, AlertConditionSet
...
sse_messages: Queue[Message] = Queue()
...
async def handle_incomming_lora():
    while running:
        try:
            ...
            elif isinstance(packet, SSEMessage):
...
async def events_handler():
    return await generated_message()
