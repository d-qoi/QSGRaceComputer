...
from qsgrc.log import ValkeyStreamHandler, get_logger
...
async def test_valkey_log():
    ...
    handler = ValkeyStreamHandler(TEST_STREAM, valkey_client=valkey_client)
    logger = get_logger(__name__, handler)
